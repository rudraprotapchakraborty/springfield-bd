  ...
  return (
    <div className="min-h-screen bg-[#f8fbf4] pt-32 pb-24 px-6 md:px-12">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-light text-zinc-900 mb-4">All <span className="font-bold">Projects</span></h1>
          <p className="text-zinc-500 text-lg">Explore our entire portfolio of completed, ongoing, and upcoming projects.</p>
        </motion.div>
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          className="mb-12 flex flex-col md:flex-row gap-6 justify-between items-center bg-white p-4 rounded-2xl shadow-sm border border-zinc-100"
        >
          ...
          <div className="relative w-full md:w-80">
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-zinc-50 border border-zinc-200 rounded-full focus:outline-none focus:border-[#00a651] focus:bg-white transition-colors text-sm"
            />
        ...
        <AnimatePresence mode="wait">
          {filteredProjects.length === 0 ? (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="flex items-center justify-center min-h-[40vh] bg-white rounded-3xl shadow-sm border border-zinc-100"
            >
              <div className="text-zinc-400 text-xl font-light flex items-center gap-3">
                <Info size={28} />
                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <img 
                      ...
                      alt={project.title} 
                    />
                    <div className="absolute top-4 right-4 z-20 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-[#00a651] uppercase">
                      {project.status}
                    </div>
                  </div>
