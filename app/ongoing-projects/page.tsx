  ...
  return (
    <div className="min-h-screen bg-[#f8fbf4] dark:bg-zinc-950 pt-32 pb-24 px-6 md:px-12 transition-colors duration-300">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-light text-zinc-900 dark:text-zinc-100 mb-4">Ongoing <span className="font-bold">Projects</span></h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-lg">Discover the projects we are currently developing to shape the future.</p>
        </motion.div>
