  ...
  return (
    <div className="min-h-screen bg-[#f8fbf4] pt-32 pb-24 px-6 md:px-12">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-light text-zinc-900 mb-4">Completed <span className="font-bold">Projects</span></h1>
          <p className="text-zinc-500 text-lg">Witness the achievements and landmarks we have delivered over the years.</p>
        </motion.div>
